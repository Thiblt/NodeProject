...
const validateIdParamOrder = [param("id_commande").notEmpty().isNumeric()];

const validateId_barParam = [param("id_bar").notEmpty().isNumeric()];
...
const validateBodyOrder = [
  ...
  body("status")
    .custom(ValidateCustomString)
    .withMessage("Invalid string value"),
];
